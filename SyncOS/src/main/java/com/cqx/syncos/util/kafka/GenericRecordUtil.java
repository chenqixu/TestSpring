...
public class GenericRecordUtil {
    ...
    public GenericRecordUtil(TaskInfo taskInfo) {
        this.schemaUtil = new SchemaUtil(taskInfo);
        this.topic = taskInfo.getDst_name();
        addTopic();
    }

    public GenericRecordUtil(SchemaUtil schemaUtil, String topic) {
    ...
    private void addTopic() {
        Schema schema = schemaUtil.getSchema();
    ...
    public byte[] genericRecord(Map<String, String> values) {
